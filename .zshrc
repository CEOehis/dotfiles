...
plugins=(
  git npm z colorize cp npm nvm vscode colored-man-pages copydir dircycle git-auto-fetch gitignore last-working-dir lol command-not-found composer docker-compose docker gcloud golang zsh-autosuggestions zsh-syntax-highlighting repo-helper aws virtualenv kubectl
)
